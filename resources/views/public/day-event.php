    ...
    <div class="page text-center">
                    ...
                    <ul class="list-unstyled">
                      ...
                      <li>
                        <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                          ...
                          <div class="unit-body"><a href="/cdn-cgi/l/email-protection#1536"><span class="__cf_email__" data-cfemail="224b4c444d6246474f4d4e4b4c490c4d5045">[email&#160;protected]</span><script data-cfhash='f9e31' type="text/javascript">/* <![CDATA[ */!function(t,e,r,n,c,a,p){try{t=document.currentScript||function(){for(t=document.getElementsByTagName('script'),e=t.length;e--;)if(t[e].getAttribute('data-cfhash'))return t[e]}();if(t&&(c=t.previousSibling)){p=t.parentNode;if(a=c.getAttribute('data-cfemail')){for(e='',r='0x'+a.substr(0,2)|0,n=2;a.length-n;n+=2)e+='%'+('0'+('0x'+a.substr(n,2)^r).toString(16)).slice(-2);p.replaceChild(document.createTextNode(decodeURIComponent(e)),c)}p.removeChild(t)}}catch(u){}}()/* ]]> */</script></a></div>
                        </div>
                      </li>
                    </ul>
                  </div>
                  <div class="rd-navbar-top-panel-right-part">
                    <div class="rd-navbar-top-panel-left-part">
                      <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                        ...
                        <div class="unit-body"><a href="login-register.php">Login/Register</a></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="rd-navbar-brand"><a href="index.php" class="reveal-inline-block">
                    <div class="unit unit-xs-middle unit-xl unit-xl-horizontal unit-spacing-xxs">
                      ...
                      <div class="unit-body text-xl-left">
                        <div class="rd-navbar-brand-title">Concord High School</div>
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    <div class="rd-navbar-mobile-header-wrap">
                      <!--Navbar Brand Mobile-->
                      <div class="rd-navbar-mobile-brand"><a href="index.php"><img width='120' height='130' src='images/logo-120x130.png' alt=''/></a></div>
                    </div>
                    <!-- RD Navbar Nav-->
                    <ul class="rd-navbar-nav">
                      ...
                      <li><a href="#">Elements</a>
                        <ul class="rd-navbar-dropdown">
                          <li><a href="grid.php">Grid</a>
                          </li>
                          <li><a href="icons.php">Icons</a>
                          </li>
                          <li><a href="tables.php">Tables</a>
                          </li>
                          <li><a href="progress-bars.php">Progress bars</a>
                          </li>
                          <li><a href="tabs-and-accordions.php">Tabs &amp; Accordions</a>
                          </li>
                          <li><a href="forms.php">Forms</a>
                          </li>
                            ...
                            <ul class="col-md-3">
                              <li>
                                ...
                                <ul class="list-unstyled offset-lg-top-20">
                                  ...
                                  <li><a href="header-center.php">Header Center, Footer Center</a></li>
                                  <li><a href="header-minimal.php">Header Minimal, Footer Center</a></li>
                                  <li><a href="header-corporate.php">Header Corporate</a></li>
                                  <li><a href="header-hamburger-menu.php">Header Hamburger Menu</a></li>
                                  <li><a href="footer-minimal.php">Footer Minimal</a></li>
                                  <li><a href="footer-widget.php">Footer Widget</a></li>
                                </ul>
                              </li>
                            </ul>
                            <ul class="col-md-3">
                              ...
                              <li>
                                ...
                                <ul class="list-unstyled offset-lg-top-20">
                                  ...
                                  <li><a href="day-event.php">Daily Events</a></li>
                                  <li><a href="event-page.php">Event Page</a></li>
                                </ul>
                              </li>
                            </ul>
                          </div>
                      ...
                      <li class="veil-md"><a href="shopping-cart.php">Shopping Cart (2)</a></li>
                    </ul>
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">Event Calendar</h1>
        ...
        <section class="section-70 section-md-114">
          <div class="shell-wide">
            <div class="range range-xs-center">
              <div class="cell-lg-3 text-sm-left offset-lg-top-147">
                  ...
                  <div class="item">
                    <div class="shell-wide">
                      <div class="range range-xs-center range-xl-left">
                        <div class="cell-sm-6 cell-md-5 cell-xl-3">
                          <article class="post-event">
                            <div class="post-event-img-overlay"><img src="images/blog/events-04-420x420.jpg" width="420" height="420" alt="" class="img-responsive">
                              <div class="post-event-overlay context-dark"><a href="apply.php" class="btn btn-primary">Book Now</a>
                                <div class="offset-top-20"><a href="event-page.php" class="btn btn-default">Learn More</a></div>
                              </div>
                            </div>
                            <div class="unit unit-lg">
                              ...
                              <div class="unit-body">
                                <div class="post-event-body text-lg-left">
                                  <h6><a href="event-page.php">Freshman Registration</a></h6>
                        ...
                        <div class="cell-sm-6 cell-md-5 cell-xl-3 offset-top-50 offset-sm-top-0">
                          <article class="post-event">
                            ...
                            <div class="unit unit-lg">
                              <div class="unit-left">
                                <div class="post-event-meta text-center">
                                  <div class="h3 text-bold reveal-inline-block reveal-lg-block">18</div>
                                  <p class="reveal-inline-block reveal-lg-block">June</p><span class="text-bold reveal-inline-block reveal-lg-block inset-left-10 inset-lg-left-0">5:00pm</span>
                                </div>
                              </div>
                              <div class="unit-body">
                                <div class="post-event-body text-lg-left">
                                  <h6><a href="event-page.php">Concord High School Board Meeting</a></h6>
                                  <ul class="list-inline list-inline-xs">
                        ...
                        <div class="cell-sm-6 cell-md-5 cell-xl-3 offset-top-50 offset-xl-top-0">
                          <article class="post-event">
                            ...
                            <div class="unit unit-lg">
                              <div class="unit-left">
                                <div class="post-event-meta text-center">
                                  <div class="h3 text-bold reveal-inline-block reveal-lg-block">22</div>
                                  <p class="reveal-inline-block reveal-lg-block">June</p><span class="text-bold reveal-inline-block reveal-lg-block inset-left-10 inset-lg-left-0">5:00pm</span>
                                </div>
                              </div>
                              <div class="unit-body">
                                <div class="post-event-body text-lg-left">
                                  <h6><a href="event-page.php">CHS School-Day Testing</a></h6>
                                  <ul class="list-inline list-inline-xs">
                        ...
                        <div class="cell-sm-6 cell-md-5 cell-xl-3 offset-top-50 offset-xl-top-0">
                          <article class="post-event">
                            ...
                            <div class="unit unit-lg">
                              ...
                              <div class="unit-body">
                                <div class="post-event-body text-lg-left">
                                  <h6><a href="event-page.php">Geometry Class</a></h6>
                                  <ul class="list-inline list-inline-xs">
                                    <li><a href="team-member-profile.php"><span class="icon icon-xxs mdi mdi-account-outline text-middle"></span><span class="inset-left-10 text-dark text-middle">Danielle Garza</span></a></li>
                                  </ul>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="cell-sm-6 cell-md-5 cell-xl-3 offset-top-50">
                          <article class="post-event">
                            <div class="post-event-img-overlay"><img src="images/blog/events-08-420x420.jpg" width="420" height="420" alt="" class="img-responsive">
                              <div class="post-event-overlay context-dark"><a href="apply.php" class="btn btn-primary">Book Now</a>
                                <div class="offset-top-20"><a href="event-page.php" class="btn btn-default">Learn More</a></div>
                              </div>
                            </div>
                            <div class="unit unit-lg">
                              <div class="unit-left">
                                <div class="post-event-meta text-center">
                                  <div class="h3 text-bold reveal-inline-block reveal-lg-block">29</div>
                                  <p class="reveal-inline-block reveal-lg-block">June</p><span class="text-bold reveal-inline-block reveal-lg-block inset-left-10 inset-lg-left-0">5:00pm</span>
                                </div>
                              </div>
                              <div class="unit-body">
                                <div class="post-event-body text-lg-left">
                                  <h6><a href="event-page.php">Parent Teacher Conference Night in Our Concord High School</a></h6>
                                  <ul class="list-inline list-inline-xs">
                                    <li><a href="team-member-profile.php"><span class="icon icon-xxs mdi mdi-account-outline text-middle"></span><span class="inset-left-10 text-dark text-middle">Walter Stanley</span></a></li>
                                  </ul>
                                </div>
                  ...
                  <div class="item">
                    <div class="shell-wide">
                      <div class="range range-xs-center range-xl-left">
                        ...
                        <div class="cell-sm-6 cell-md-5 cell-xl-3 offset-top-50 offset-xl-top-0">
                          <article class="post-event">
                            <div class="post-event-img-overlay"><img src="images/blog/events-07-420x420.jpg" width="420" height="420" alt="" class="img-responsive">
                              <div class="post-event-overlay context-dark"><a href="apply.php" class="btn btn-primary">Book Now</a>
                                <div class="offset-top-20"><a href="event-page.php" class="btn btn-default">Learn More</a></div>
                              </div>
                            </div>
        ...
        <div class="shell section-60">
          <div class="range range-lg-justify range-xs-center">
            <div class="cell-md-3 cell-lg-2">
              <!--Footer brand--><a href="index.php" class="reveal-inline-block"><img width="206" height="223" src="images/logo-206x223.png" alt=""></a>
            </div>
                ...
                <ul class="list-unstyled contact-info list">
                  ...
                  <li class="offset-top-15">
                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                      ...
                      <div class="unit-body"><a href="/cdn-cgi/l/email-protection#6b48"><span class="__cf_email__" data-cfemail="21484f474e6145444c4e4d484f4a0f4e5346">[email&#160;protected]</span><script data-cfhash='f9e31' type="text/javascript">/* <![CDATA[ */!function(t,e,r,n,c,a,p){try{t=document.currentScript||function(){for(t=document.getElementsByTagName('script'),e=t.length;e--;)if(t[e].getAttribute('data-cfhash'))return t[e]}();if(t&&(c=t.previousSibling)){p=t.parentNode;if(a=c.getAttribute('data-cfemail')){for(e='',r='0x'+a.substr(0,2)|0,n=2;a.length-n;n+=2)e+='%'+('0'+('0x'+a.substr(n,2)^r).toString(16)).slice(-2);p.replaceChild(document.createTextNode(decodeURIComponent(e)),c)}p.removeChild(t)}}catch(u){}}()/* ]]> */</script></a></div>
                    </div>
                  </li>
                </ul>
              </div>
