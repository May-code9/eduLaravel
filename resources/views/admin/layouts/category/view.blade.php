              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="center"><a href="/bookCategory/{{ $getBookCategory->id }}/edit" id="edit" class="btn btn-md btn-primary mr-2" >Edit</a></td>
                  </tr>

                </tbody>
                @empty
                <h1 style="text-align:center">Book Category Table is empty</h1>
                @endforelse
                <tfoot>
                  <tr>
                    <th>Id</th>
