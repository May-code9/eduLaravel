      ...
      <div class="row">
        ...
        <div class="col-md-10 col-md-push-1">
          ...
          <div class="box box-warning">
            ...
            <!-- form start -->
            <form method="post" action="/author/{{ $author->id }}" enctype="multipart/form-data">
              {{ method_field('PUT') }}
              {{ csrf_field() }}
              <div class="box-body">
                <div class="form-group{{ $errors->has('author_name') ? ' has-error' : '' }}">
                  <label>Name of Author</label>
                  <input type="text" class="form-control" name="author_name" id="author_name" value="{{ $author->author_name }}" placeholder="Enter ..." required/>
                ...
                <div class="form-group{{ $errors->has('about_author') ? ' has-error' : '' }}">
                  ...
                  <!-- tools box -->
                  <textarea id="editor1" name="about_author" placeholder="Enter ..." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required>{{ $author->about_author }}</textarea>
