        ...
        <div class="col-md-4 col-md-push-4 col-sm-6 col-sm-push-3">
          ...
          <div class="box box-warning">
            <div class="box-header">
              <h3 class="box-title">Edit Author's Image</h3>
            </div><!-- /.box-header -->

            <!-- form start -->
            <form method="post" action="/edit Author Image/{{ $author->id }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">
                <input type="hidden" name="user_id" value="{{ Auth::user()->id }}"/>

                <div class="form-group">
                  <p>Author's Current Image</p>
                  <img class="img-responsive" src="{{ asset('images/authors/' . $author->author_image) }}" >
                </div>

                <div class="form-group{{ $errors->has('author_image') ? ' has-error' : '' }}">
                  <label>Author's Image</label>
                  <input type="file" name="author_image" id="author_image" value="" required>
