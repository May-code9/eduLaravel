            ...
            <form method="post" action="/book/{{ $book->id }}">
              ...
              <div class="box-body">
                <div class="form-group{{ $errors->has('book_name') ? ' has-error' : '' }}">
                  ...
                  <input type="text" name="book_name" class="form-control" value="{{ $book->book_name }}" placeholder="Enter..." required/>
                ...
                <div class="form-group{{ $errors->has('about_book') ? ' has-error' : '' }}">
                  ...
                  <!-- tools box -->
                  <textarea id="editor1" name="about_book" placeholder="Enter ..." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required>{{ $book->about_book }}</textarea>
                ...
                <div class="form-group{{ $errors->has('book_cost') ? ' has-error' : '' }}">
                  ...
                  <input type="text" name="book_cost" class="form-control" value="{{ $book->book_cost }}" placeholder="Enter..." required/>
