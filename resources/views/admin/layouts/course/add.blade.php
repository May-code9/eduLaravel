            ...
            <form method="post" action="{{ route('course.store') }}" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group{{ $errors->has('course') ? ' has-error' : '' }}">
                  ...
                  <input type="text" class="form-control" name="course" id="name" value="{{ old('course') }}" placeholder="Enter ..." required/>
                ...
                <div class="form-group{{ $errors->has('about_course') ? ' has-error' : '' }}">
                  ...
                  <!-- tools box -->
                  <textarea id="editor1" name="about_course" placeholder="Enter ..." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required></textarea>
